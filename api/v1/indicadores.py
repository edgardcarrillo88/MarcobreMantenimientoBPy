...
@router.post("/BorrarDatadeReids", tags=["Indicadores"])
async def Borrar_Data_de_Redis ():
    
    print("Borrando datos de indicadores de redis")
    ...
    print("Finalizando el proceso de borrado de datos de indicadores desde redis")
